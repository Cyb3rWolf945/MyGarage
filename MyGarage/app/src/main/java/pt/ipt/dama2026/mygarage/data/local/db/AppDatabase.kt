...
/**
 * Base de dados Room da aplicação. Contém veículos, serviços e peças.
 *
 * A instância é criada como singleton no companion object para evitar múltiplas
 * aberturas da BD. As migrações (v4→v10) aplicam alterações incrementais ao schema
 * sem perder dados: adicionam colunas, convertem formatos, removem tabelas obsoletas.
 *
 * Regista globalmente os Converters para UUID e List<String> via @TypeConverters.
 */
@Database(
    entities = [
        VehicleEntity::class,
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // v4→v5: adiciona colunas mileageKm (quilometragem canónica)
        ...
        // v5→v6: migra de imagem única para múltiplas imagens (JSON array)
        ...
        // v6→v7: adiciona updatedAt para deteção de delta no sync
        ...
        // v7→v8: adiciona isDeleted para soft delete
        ...
        // v8→v9: adiciona mileageToNextServiceKm
        ...
        // v9→v10: remove tabelas pieces e service_log_pieces (obsoletas)
